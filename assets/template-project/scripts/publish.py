...
See `references/toolchain-publishing.md` for the full Datasette toolchain.
"""
...
# defaults work for most civic-data tables. See references/toolchain-publishing.md
